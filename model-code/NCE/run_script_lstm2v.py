        ...
        for dim in dims:
            for maxlen in maxlens:
                for dataName in dataNames:
                    ...
                    # command = flag + 'python lstm_pretrain.py -data ' + dataName + ' -saving lstm2v_' + dataName + '_dim' + dim + ' -vocab ' + vocab + ' -dim ' + dim + ' -len ' + maxlen
                    # print command
                    # os.system(command)

                    command = 'THEANO_FLAGS=''exception_verbosity=high'' ' + 'python lstm2vec.py -dataPre ' + dataName + ' -data ' + dataName + ' -vocab ' + vocab + ' -dim ' + dim + ' -len ' + maxlen + ' -saving lstm2v_' + dataName + '_' + dataName + '_dim' + dim + '_len' + maxlen
                    print command
                    os.system(command)
